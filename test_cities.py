...
def test_swap_cities():
    new_road_map = [("California", "Sacramento", 38.555605, -121.468926),\
		("Colorado", "Denver", 39.7391667, -104.984167),\
		("Connecticut",	"Hartford", 41.767, -72.677)]

    assert swap_cities(new_road_map, 0, 2)==[("Connecticut", "Hartford", 41.767, -72.677),\
                                          ("Colorado", "Denver", 39.7391667, -104.984167),\
                                          ("California", "Sacramento", 38.555605, -121.468926)]


    new_road_map = swap_cities(road_map, 0, 12)

    assert new_road_map == [('Springfield', 39.78, -89.65),('Juneau', 58.3, -134.42),\
                         ('Phoenix', 33.45, -112.07), ('Little Rock', 34.74, -92.33),\
                         ('Sacramento', 38.56, -121.47), ('Denver', 39.74, -104.98),\
                         ('Hartford', 41.77, -72.68), ('Dover', 39.16, -75.53),\
                         ('Tallahassee', 30.45, -84.27), ('Atlanta', 33.76, -84.39),\
    ...
    total = swap_cities(new_road_map, 3, 6)
    ...
    new_road_map = [('Springfield', 39.78, -89.65),('Juneau', 58.3, -134.42),\
                         ...
                         ('Sacramento', 38.56, -121.47), ('Denver', 39.74, -104.98),\
                         ('Hartford', 41.77, -72.68), ('Dover', 39.16, -75.53)]
    total = swap_cities(new_road_map, 2, 5)
    assert total == [('Springfield', 39.78, -89.65),('Juneau', 58.3, -134.42),\
